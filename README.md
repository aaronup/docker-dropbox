...
This repository provides the [touchto/dropbox](https://docker.touchto.io/touchto/dropbox/) image.

## Usage examples

### Quickstart

    docker run -d --restart=always --name=dropbox docker.touchto.io/touchto/dropbox

### Dropbox data mounted to local folder on the host

    docker run -d --restart=always --name=dropbox \
    -v /path/to/localfolder:/dbox/Dropbox \
    docker.touchto.io/touchto/dropbox
